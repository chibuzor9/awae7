...
export default function WcagCardDeck() {
  ...
  const filteredCards = useMemo(() => {
    ...
    return wcagCards.filter((card) => {
      /* Principle filter */
      if (selectedPrinciple && card.principle !== selectedPrinciple) return false;
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : cn(
                          ...
                          principleHoverColors[principle]
                        )
                  )}
                >
                  {principle}
      ...
      {filteredCards.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="mt-1 max-w-md text-sm text-gray-500">
            No WCAG criteria match your current search or filters. Try adjusting
            your search term or clearing the filters to see more results.
          </p>
          <button
            type="button"
            onClick={() => {
