...
import type { EndUserReport as EndUserReportType, EndUserCategory } from "@/types";
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-gray-500 mt-1">
                These are the most important steps to improve accessibility on
                your site.
              </p>
            </CardHeader>
      ...
      <CardBody className="space-y-3">
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs">
            ...
            <span
              className={cn("font-semibold tabular-nums", getScoreTextColor(category.score))}
            >
              {category.score}/100
            </span>
          </div>
