      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <header className="text-center mb-10">
          ...
          <p className="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">
            Enter a URL below to run an automated WCAG 2.2 accessibility audit.
            You will receive tailored reports for developers, auditors, and end
            users.
          </p>
        </header>
            ...
            <CardBody className="py-16 flex flex-col items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  This may take a moment while we scan the page and generate
                  your reports.
                </p>
              </div>
